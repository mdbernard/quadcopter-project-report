...
In this report, we detail the design of a controller for the quadcopter system depicted in Figure 1. Our design goal is to stablize the system with zero steady-state error in the height and orientation of the system for a step input. % TODO: include figure here
